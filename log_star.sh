...
#uniquely mapped read pairs number
uniq_map_reads_double_n2=$(($uniq_map_reads_n))
uniq_map_reads_double_n=$(($uniq_map_reads_double_n2*2))

#uniquely mapped reads pairs percentage
...
printf "${uniq_map_reads_double_n} \t ${uniq_map_reads_p} \t ${mm_um_cr_n} \t ${unmapped_reads_n} \n" >> STAR_log.csv
